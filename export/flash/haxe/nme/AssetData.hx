...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/dataship4.png", nme.NME_assets_dataship4_png);
			type.set ("assets/dataship4.png", Reflect.field (AssetType, "image".toUpperCase ()));
			className.set ("assets/Dev/brad.psd", nme.NME_assets_dev_brad_psd);
			type.set ("assets/Dev/brad.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
			className.set ("assets/Dev/concept.psd", nme.NME_assets_dev_concept_psd);
			type.set ("assets/Dev/concept.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
			className.set ("assets/Dev/walkcycle.psd", nme.NME_assets_dev_walkcycle_psd);
			type.set ("assets/Dev/walkcycle.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
			className.set ("assets/Dev/WalkCycleSprite.psd", nme.NME_assets_dev_walkcyclesprite_psd);
			type.set ("assets/Dev/WalkCycleSprite.psd", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class NME_assets_dataship4_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_dev_brad_psd extends flash.utils.ByteArray { }
class NME_assets_dev_concept_psd extends flash.utils.ByteArray { }
class NME_assets_dev_walkcycle_psd extends flash.utils.ByteArray { }
class NME_assets_dev_walkcyclesprite_psd extends flash.utils.ByteArray { }
